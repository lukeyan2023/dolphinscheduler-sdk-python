...
class SparkDeployMode(str):
    """SPARK deploy mode, for now it just contain `CLUSTER`, `CLIENT`"""
...
class SeaTunnel(Task):
    ...
    def __init__(
            ...
            name: str,
            raw_script: str,
            startup_script: Optional[StartupScript] = StartupScript.SEATUNNEL,
            deploy_mode: Optional[SeatunnelDeployMode] = SeatunnelDeployMode.LOCAL,
